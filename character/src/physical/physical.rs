...
impl PhysicalInfo {
    ...
    pub fn edit(&mut self) {
        ...
        Self::list(List::Hand);
        self.dominant_hand = match _read_int() {
    ...
    pub fn list(list: List) {
        match list {
            List::Build => {
                ...
                println!("Enter the number of your Physic: ");
            },
            List::Hand => {
                ...
                println!("Enter the number of your Dominant Hand: ");
            }
            List::Height => println!("Enter your Height(150-200 cm): "),
            List::Weight => println!("Enter your Weigh(50-150 kg)t: "),
            List::Skin => {
                println!("Skin Colour");
